...
rbind(incidence_rate = coef2, log_poverty_percent = coef3, median_age_female = coef4,
      regionNortheast = coef5, regionSouth = coef6, regionWest = coef7, 
      pct_hs18_24 = coef8, pct_hs25_over = coef9, pct_unemployed16_over = coef10,
      pct_public_coverage = coef11) 
```
